...
Original file is located at
    https://colab.research.google.com/drive/1ZS0NwOT0A3UT9ffZX0kkxLp2zDjhbHKL
"""
...
# Initialize SQLite database with sample
def init_db():
    try:
...
# Initialize database and display form
init_db()
display(amount_input, category_input, date_input, submit_button, viz_button)